...
export class EasternPalace extends Dungeon {
    ...
    public override initialize() {
        ...
        this.locations.get("Eastern Palace - Big Key Chest")?.setRequirements((item, locations, items, locations_checked) => {
        ...
        this.locations.get("Eastern Palace - Boss")?.setRequirements((item, locations, items, locations_checked) => {
